...
OUTPUT_DIR = MODEL_DIR / "alpha_rs_crowding_mini4_experiment"
CASE_DIR = ROOT_DIR / "_case_zip" / "THU-BDC2026-82247deba1c7464295f66363efc94fd85549bfe0"

EXPERIMENT = {
    "label": "alpha_v3_rs_crowding_mini4",
    "feature_set": "base_alpha_v3_rs_crowding_mini4",
    "model_dir": MODEL_DIR / "alpha_v3_rs_crowding_mini4",
    "result_path": APP_DIR / "output" / "result_alpha_v3_rs_crowding_mini4.csv",
...
def main() -> None:
    ...
    summary_path = OUTPUT_DIR / "alpha_rs_crowding_mini4_summary.csv"
    report_path = OUTPUT_DIR / "alpha_rs_crowding_mini4_report.md"
    summary.to_csv(summary_path, index=False, encoding="utf-8-sig")

    lines = [
        "# Relative Strength + Crowding Risk Mini4 实验",
        "",
    ...
    print(f"[alpha_rs_crowding_mini4] wrote {summary_path}")
    print(f"[alpha_rs_crowding_mini4] wrote {report_path}")
