...
OUTPUT_DIR = MODEL_DIR / "trend_rerank_signal_experiment"
RESULTS_DIR = OUTPUT_DIR / "results"
BACKTEST_DIR = OUTPUT_DIR / "backtests"
RERANK_SIGNAL_COLUMN = "trend_persistence_score_10d_v2"
...
def main() -> None:
    ...
    df.to_csv(OUTPUT_DIR / "trend_rerank_signal_summary.csv", index=False, encoding="utf-8-sig")
    ...
    (OUTPUT_DIR / "trend_rerank_signal_report.md").write_text("\n".join(lines), encoding="utf-8")
    print(f"[trend_rerank_signal] wrote {OUTPUT_DIR / 'trend_rerank_signal_summary.csv'}")
    print(f"[trend_rerank_signal] wrote {OUTPUT_DIR / 'trend_rerank_signal_report.md'}")
